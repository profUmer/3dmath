...
},
{
  ...
  "number": "1.1",
  "title": "Plane basics",
  "body": " Plane basics  It might be useful to start with something that is not a plane, as shown below.   The curvature of space-time around a massive object is not a plane.    Notice how the fabric of space-time in curves around the massive object. That's not a plane. We need a flat sheet, like the image below:   The plane . Note that I have only drawn a tiny part of the infinitely large plane.     The whole \"infinitely large and infinitesimally thin\" definition throws off a lot of people. It's hard to imagine something so different to what we see in the real world. But planes are defined by simplest equations. The plane in that stretches out forever is described by the following equation: That's it! Every point on the plane has an coordinate of zero. Could we have a simpler equation?  Wait, there's more! These are also plane equations: and are shown visually below.  The planes and drawn in pale green and pale blue respectively.       We've covered the essential planes that cut through the origin and are lined up the three coordinate axes. But what about planes that don't go through the origin? Also easy! Check out the three planes below:  The planes , and .       The three planes above correspond to the the equations: Notice the number on the right side of the equals sign above and compare it to . Did you notice that the number corresponds to the closest distance between the plane and the origin? For example the plane is or more units away from the spot where x, y, and z are all zero. Or another way to think about it, is that the plane is units away from the plane   But hold on, the plane is also at least units from the origin, but on the negative side of the x-axis. That might convince you that the number is actually the \"signed\" minimum distance from the origin, where the sign tells you whether the plane cuts through the positive or negative side of the relevant axis. That means we can generalize the plane equation to the following: where is the called the signed distance to the origin.  This idea of a signed distance also applies to the and planes as well, as shown in the following two figures.  The planes , and .       The planes , and .       "
},
{
...
{
  "id": "figure-planes-x-away-from-origin",
  "level": "2",
  "url": "sec-plane-basics.html#figure-planes-x-away-from-origin",
  "type": "Figure",
  "number": "1.1.4",
  "title": "",
  "body": " The planes , and .     "
...
{
  "id": "figure-planes-y-away-from-origin",
  "level": "2",
  "url": "sec-plane-basics.html#figure-planes-y-away-from-origin",
  "type": "Figure",
  "number": "1.1.5",
  "title": "",
  "body": " The planes , and .     "
...
{
  "id": "figure-planes-z-away-from-origin",
  "level": "2",
  "url": "sec-plane-basics.html#figure-planes-z-away-from-origin",
  "type": "Figure",
  "number": "1.1.6",
  "title": "",
  "body": " The planes , and .     "
...
{
  "id": "figure-plane-equation-with-controls",
  "level": "2",
  "url": "sec-plane-code-start.html#figure-plane-equation-with-controls",
  "type": "Figure",
  "number": "1.2.2",
  "title": "",
